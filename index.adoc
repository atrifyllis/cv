...
I consider myself a problem-solver and a solution-oriented developer. I like to work in *Agile* teams and co-operating with my colleagues,
...
architecture, but also worked on backend features. I was also responsible of creating Jenkins pipelines using Groovy
DSL.
