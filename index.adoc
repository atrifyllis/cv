...
I am part of the bugfixing team in the Entry Exit System of euLisa. I am also heavily involved in some devops tasks e.g. coordinating releases, making sure that everything is running smoothly in development environment.
